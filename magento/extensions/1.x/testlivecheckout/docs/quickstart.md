...
curl -fsLO \
  https://docs.auroraextensions.com/magento/extensions/1.x/testlivecheckout/1.1.0/puppeteer/src/guest-checkout/authorizenet.js
```
...
To see what the end result will look like, take a look at [Guest Checkout](https://docs.auroraextensions.com/magento/extensions/1.x/testlivecheckout/latest/examples/guest-checkout/authorizenet/).
